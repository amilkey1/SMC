...
ntax           = [2,2,2,2,2,2,2] # number of taxa in each species
...
nloci          = 20          # number of loci (conditionally independent given species tree)
#seqlen         = 500       # number of sites in each gene
seqlenbegin    = '1, 501, 1001, 1501, 2001, 2501, 3001, 3501, 4001, 4501, 5001, 5501, 6001, 6501, 7001, 7501, 8001, 8501, 9001, 9501' # for now, need to manually set this as well in the SMC and sim conf files
seqlenend      =  '500, 1000, 1500, 2000, 2500, 3000, 3500, 4000, 4500, 5000, 5500, 6000, 6500, 7000, 7500, 8000, 8500, 9000, 9500, 10000'
...
simprogname    = 'dub'    # name of program used to simulate data (expected to be in $HOME/bin on cluster)
...
rnseed         = 1235     # overall pseudorandom number seed for everything except setting sim conf file
rnsimseed      = 1235       # overall pseudorandom number seed for setting sim conf file
...
def createSimConf(rep_index):
    ...
    s += 'subset = locus11[nucleotide]:5001-5500\n'
    s += 'subset = locus12[nucleotide]:5501-6000\n'
    s += 'subset = locus13[nucleotide]:6001-6500\n'
    s += 'subset = locus14[nucleotide]:6501-7000\n'
    s += 'subset = locus15[nucleotide]:7001-7500\n'
    s += 'subset = locus16[nucleotide]:7501-8000\n'
    s += 'subset = locus17[nucleotide]:8001-8500\n'
    s += 'subset = locus18[nucleotide]:8501-9000\n'
    s += 'subset = locus19[nucleotide]:9001-9500\n'
    s += 'subset = locus20[nucleotide]:9501-10000\n'
    s += '\n'

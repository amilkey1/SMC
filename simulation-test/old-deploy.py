...
ntax           = [5, 2,10,4,3,5] # number of taxa in each species
lamda          = 10.0         # speciation rate (note: lambda is a python keyword)
...
nparticles     = 30000       # number of particles to use for SMC

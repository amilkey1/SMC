...
//        double                      getLineageHeight(const Node* nd) const;
    ...
    vector<pair<tuple<string, string, string>, double>>                         buildFromNewickTopology(const std::string newick);
        ...
        double                      getLogLikelihood() {return _gene_tree_log_likelihood;}
        double                      getLogCoalescentLikelihood() {return _gene_tree_log_coalescent_likelihood;}
...
//            debugLogLikelihood(nd, log_like);
    ...
    inline void Forest::buildFromNewick(const std::string newick) {
...
//                evolveSpeciesFor(s.second, species_tree_increment, 0.0); // TODO: fix species tree height
    ...
    inline void Forest::resetSpeciesTree(vector<pair<tuple<string, string, string>, double>> t, int smallest_num_species) { // TODO: walk thru this function
